...
export class SearchResturant extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // feature: "",
      // price: "",
      isOpenMenuImgModal: false,
      isOpenRestPicsModal: false,
  ...
  showMenuImgModal = () => {
    this.setState({isOpenMenuImgModal: true});
  };

  hideMenuImgModal = () => {
    this.setState({isOpenMenuImgModal: false});
  };

  showRestPicsModal = () => {
    this.setState({isOpenRestPicsModal: true});
  };
  ...
  hideRestPicsModal = () => {
    this.setState({isOpenRestPicsModal: false});
  };
  reserveBook = (e) => {
    e.preventDefault();
  ...
  render() {
    ...
    //Krutiks code starts here
    //let restaurantFiltered = [...this.state.restaurantList];
    ...
    if (this.state.resType !== "")
      // console.log("Type: " + typeof(restaurantFiltered));
      resTypeFiltered = restaurantFiltered.filter((restaurant) => restaurant.resType.includes(this.state.resType));
    ...
    return (
      <div className="Homepage">
        ...
        {/* Resturant cards code start here */}

        <div className="resturantFilters">
          {/* Kind of resturant*/}
          <form>
            {/* <label htmlFor="resType">resType: </label> */}
            ...
            {/* <label htmlFor="resCusine">resCusine: </label> */}
            ...
            {/* <label htmlFor="resFeatures">resFeatures: </label> */}
          ...
          {/* feature of resturant */}

          {/* Modal of menu page */}
          <Modal show={this.state.isOpenMenuImgModal} onHide={this.hideMenuImgModal}>
            <Modal.Header style={modalBgColor}>
              <Modal.Title style={{fontSize: "16px", color: "#ffa834"}}>
                Menu
                <a href="# " style={registerCloseBtn} onClick={this.hideMenuImgModal}>
                  &times;
                </a>
              </Modal.Title>
            </Modal.Header>
            <Modal.Body style={modalBgColor}>
              {" "}
              <img src="https://b.zmtcdn.com/data/menus/104/16797104/a6b3fe53b97314a02bf201ff61b7885c.jpg" />{" "}
            </Modal.Body>
          </Modal>
          {/* Modal of menu page */}

          {/* Modal of restaurnats pics page */}
          <Modal show={this.state.isOpenRestPicsModal} onHide={this.hideRestPicsModal}>
            <Modal.Header style={modalBgColor}>
              <Modal.Title style={{fontSize: "16px", color: "#ffa834"}}>
                Pics
                <a href="# " style={registerCloseBtn} onClick={this.hideRestPicsModal}>
                  &times;
                </a>
              </Modal.Title>
            </Modal.Header>
            <Modal.Body style={modalBgColor}>
              <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                  <div className="carousel-item active" style={{backgroundImage: "url('https://b.zmtcdn.com/data/reviews_photos/d0d/8d3496e4751918a608cc2bd5868cdd0d_1444877415.jpg')"}}>
                    <div className="carousel-caption d-none d-md-block"></div>
                  </div>
                  <div className="carousel-item" style={{backgroundImage: "url('https://b.zmtcdn.com/data/pictures/chains/4/16797104/f555a56dca77efc98d1e7d92765bf423.jpg')"}}>
                    ">
                    <div className="carousel-caption d-none d-md-block"></div>{" "}
                  </div>
                  <div
                    ...
                    style={{
                      backgroundImage: "url('https://b.zmtcdn.com/data/reviews_photos/267/dc60ab30a60541fbd29ad5a1cde56267_1562623924.jpg')",
                    }}
                  >
                    <div className="carousel-caption d-none d-md-block"></div>{" "}
                  </div>{" "}
                  ...
                  <div className="card" style={{backgroundImage: `url(${restaurant.resPics[0]})`}}>
                    <div className="card-body">
                      ...
                      <div className="read-more">
                        {/* <a href="# " onClick={this.showMenuImgModal} style={menuMargin}>
                          Menu
                        </a>
                        <a href="# " onClick={this.showRestPicsModal}>
                          See more pics
                        </a> */}
